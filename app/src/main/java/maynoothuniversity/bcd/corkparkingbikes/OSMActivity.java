...
//        }
    ...
    private void setupPark() {
        ...
        finbarr.setTitle("Saint Finbarr's Car Park (" + date + ")");
        ...
        merchant.setTitle("Merchants Quay Car Park (" + date + ")");
        ...
        grand.setTitle("Grand Parade Car Park (" + date + ")");
        ...
        carroll.setTitle("Carrolls Quay Car Park (" + date + ")");
        ...
        city.setTitle("City Hall - Eglington Street Car Park (" + date + ")");
        ...
        blackash.setTitle("Black Ash Park & Ride (" + date + ")");
        ...
        north.setTitle("North Main St. Car Park (" + date + ")");
        ...
        paul.setTitle("Paul St. Car Park (" + date + ")");
    ...
    private void setupBike() {
        ...
        if ((bikeDrawable) != null) {
            ...
            gaol_walk.setTitle("Goal Walk (" + date + ")");
            ...
            fitz_park.setTitle("Fitzgerald's Park (" + date + ")");
            ...
            bandfield.setTitle("Bandfield (" + date + ")");
            ...
            dyke_parade.setTitle("Dyke Parade (" + date + ")");
            ...
            mercy_hos.setTitle("Mercy Hospital (" + date + ")");
            ...
            fin_bridge.setTitle("St. Fin Barre's Bridge (" + date + ")");
            ...
            pope_quay.setTitle("Pope's Quay (" + date + ")");
            ...
            north_st.setTitle("North Main St. (" + date + ")");
            ...
            grattan_st.setTitle("Grattan St. (" + date + ")");
            ...
            wandesford_quay.setTitle("Wandesford Quay (" + date + ")");
            ...
            bishop_st.setTitle("Bishop St. (" + date + ")");
            ...
            camden_quay.setTitle("Camden Quay (" + date + ")");
            ...
            corn_market.setTitle("Corn Market (" + date + ")");
            ...
            lapp_quay.setTitle("Lapp's Quay (" + date + ")");
            ...
            patrick_st.setTitle("St. Patrick's St. (" + date + ")");
            ...
            south_st.setTitle("South Main St. (" + date + ")");
            ...
            grand_parade.setTitle("Grand Parade (" + date + ")");
            ...
            peace_park.setTitle("Peace Park (" + date + ")");
            ...
            south_gate.setTitle("South Gate Bridge (" + date + ")");
            ...
            coburg_st.setTitle("Coburg St. (" + date + ")");
            ...
            emmet_place.setTitle("Emmet Place (" + date + ")");
            ...
            south_mall.setTitle("South Mall (" + date + ")");
            ...
            commerce.setTitle("College of Commerce (" + date + ")");
            ...
            mat_statue.setTitle("Father Mathew Statue (" + date + ")");
            ...
            cork_music.setTitle("Goal Walk (" + date + ")");
            ...
            brian_boru.setTitle("Brian Boru Bridge (" + date + ")");
            ...
            bus_station.setTitle("Bus Station (" + date + ")");
            ...
            cork_hall.setTitle("Cork City Hall (" + date + ")");
            ...
            glanmire.setTitle("Lower Glanmire Rd. (" + date + ")");
            ...
            clontarf.setTitle("Clontarf Street (" + date + ")");
            ...
            kent_station.setTitle("Kent Station (" + date + ")");
...
//                    return total;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.about_id:
                AlertDialog.Builder aboutBuilder = new AlertDialog.Builder(OSMActivity.this);
                view = getLayoutInflater().inflate(R.layout.about_map_layout, null);
                aboutBuilder.setView(view);
                aboutBuilder.setPositiveButton("Close", new DialogInterface.OnClickListener() {
                    @Override
            ...
            case R.id.attribution_id:
                ...
                view = getLayoutInflater().inflate(R.layout.attribution_layout, null);
